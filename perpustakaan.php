...
echo "Buku 1:" . $buku1->getJudul() . $buku1->getPengarang() . " (" . $buku1->getJumlahHalaman() . " halaman, " . $buku1->getStatusPinjam() . ")" . PHP_EOL;
echo "Buku 2:" . $buku1->getJudul() . $buku1->getPengarang() . " (" . $buku2->getJumlahHalaman() . " halaman, " . $buku2->getStatusPinjam() . ")" . PHP_EOL;
...
echo "Buku 2:" . $buku2->getJudul() . " (" . $buku1->getstatuspinjam() . ")" . PHP_EOL;
